...
简介：进行网络判断的三方，可通过通知直接进行网络的通知，从而判断页面的状态等<br>
举例：
```swift
/* 实时监控网络 */
...
简介：swift版的afnetworking，用于网络接口的申请<br>
举例：
```swift
/*  接口post请求
*  url: 传过来的url
...
简介：一个网络接口申请方法，基于Alamofire的高度封装 <br>
举例：


### DGElasticPullToRefresh
https://github.com/gontovnik/DGElasticPullToRefresh.git  <br>
简介：一个下拉刷新的三方，用于webview的页面的下拉刷新<br>
举例：
```swift
...
### SnapKit
https://github.com/SnapKit/SnapKit <br>
简介：可进行页面布局的适配，轻量级Autolayout封装，用于swift<br>
举例：
```swift
import SnapKit
...
简介：可进行页面布局的适配，轻量级Autolayout封装，用于OC<br>
举例：
```OC
...
### MBProgressHUD
https://github.com/matej/MBProgressHUD  <br>
简介：OC中经典的用于页面加载的动画，进行swift简单的封装<br>
举例：
```swift
...
https://github.com/marcuswestin/WebViewJavascriptBridge.git  <br>
简介：用于js与原生之间的交互<br>
举例：
```swift
...
* [iOS开发-极光推送SDK使用笔记](http://blog.csdn.net/James_1_2_1_1/article/details/73287239)<br>
简介：极光推送，用于远程消息推送<br>
举例：
```swift
...
https://github.com/anchoriteFili/WechatLogTest <br>
简介：用于微信的登录的简单封装
#### 创建HYHttpTool.swift
```swift
