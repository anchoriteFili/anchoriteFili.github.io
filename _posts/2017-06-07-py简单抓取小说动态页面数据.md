...
1> 打开页面，观察是否是动态加载页面
![9.png](resources/39E779EFF6DE48A73D424D7312ECE15A.png =2156x786)
2> 查找隐藏的加载内容部分的链接
![1.png](resources/67DF13A94408F7EA0C6D7B55DDA311EA.png =2152x990)
3> 找到链接所需要的对应的链接的参数
![2.png](resources/F81242539B89D0512DB57084DF3FDF10.png =2018x752)
4> 在网页源码中找到对应的参数
![3.png](resources/9DED5023271B5875C0F0BCAC6635406B.png =706x108)
5> 从源码中正则提取相关参数
```py
